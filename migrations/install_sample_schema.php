...
class install_sample_schema extends \phpbb\db\migration\migration
{
	...
	{
		return $this->db_tools->sql_column_exists($this->table_prefix . 'users', 'user_gmerk');
	}
	...
	public function update_schema()
	{
		return [
			/*'add_tables'		=> [
				$this->table_prefix . 'fjs9_gmerk_table'	=> [
					'COLUMNS'		=> [
						'gmerk_id'			=> ['UINT', null, 'auto_increment'],
						'gmerk_name'			=> ['VCHAR:255', ''],
					],
					'PRIMARY_KEY'	=> 'gmerk_id',
				],
			],*/
			'add_columns'	=> [
				$this->table_prefix . 'users'			=> [
					'gmerk_rachunek_mbp'			=> ['VCHAR:8', ''],
                    'gmerk_stempel_id'				=> ['VCHAR:4', ''],
				],
			],
		];
	}
