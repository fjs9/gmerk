...
class install_sample_data extends \phpbb\db\migration\migration
{
	...
	{
		return $this->config->offsetExists('fjs9_gmerk_sample_int');
	}
	...
	public function update_data()
	{
		return [
			...
			/*['config.add', ['fjs9_gmerk_sample_int', 0]],
			['config.add', ['fjs9_gmerk_sample_str', '']],

			// Add a new config_text table setting
			['config_text.add', ['fjs9_gmerk_sample', '']],

			// Add new permissions
			['permission.add', ['a_new_fjs9_gmerk']], // New admin permission
			['permission.add', ['m_new_fjs9_gmerk']], // New moderator permission
			['permission.add', ['u_new_fjs9_gmerk']], // New user permission
			...
			['permission.permission_set', ['ROLE_ADMIN_FULL', 'a_new_fjs9_gmerk']], // Give ROLE_ADMIN_FULL a_new_fjs9_gmerk permission
			['permission.permission_set', ['ROLE_MOD_FULL', 'm_new_fjs9_gmerk']], // Give ROLE_MOD_FULL m_new_fjs9_gmerk permission
			['permission.permission_set', ['ROLE_USER_FULL', 'u_new_fjs9_gmerk']], // Give ROLE_USER_FULL u_new_fjs9_gmerk permission
			['permission.permission_set', ['ROLE_USER_STANDARD', 'u_new_fjs9_gmerk']], // Give ROLE_USER_STANDARD u_new_fjs9_gmerk permission
			['permission.permission_set', ['REGISTERED', 'u_new_fjs9_gmerk', 'group']], // Give REGISTERED group u_new_fjs9_gmerk permission
			['permission.permission_set', ['REGISTERED_COPPA', 'u_new_fjs9_gmerk', 'group', false]], // Set u_new_fjs9_gmerk to never for REGISTERED_COPPA

			// Add new permission roles
			['permission.role_add', ['gmerk admin role', 'a_', 'a new role for admins']], // New role "gmerk admin role"
			['permission.role_add', ['gmerk moderator role', 'm_', 'a new role for moderators']], // New role "gmerk moderator role"
			['permission.role_add', ['gmerk user role', 'u_', 'a new role for users']], // New role "gmerk user role"

			// Call a custom callable function to perform more complex operations.
			['custom', [[$this, 'sample_callable_install']]],*/

            // a po kiego nam to teraz
		];
	}
